...
SELECT 
    ...
    mean(watts) AS watts 
INTO 
    wattvisiondb."default".sensor_reads_5m 
FROM 
    wattvisiondb."default".sensor_reads 
GROUP BY 
    time(5m), sensor_id, sensor_type 
END
...
finish = (table=<-) => table |> group(by: ["sensor_id", "sensor_type"]) |> set(key: "_measurement", value: "sensor_reads_5m" ) |>  to(org: "67631eeb30d3c975", bucket: ""wattvisiondb/default"") 
