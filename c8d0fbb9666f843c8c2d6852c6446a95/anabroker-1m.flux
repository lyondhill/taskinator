//CREATE CONTINUOUS
//QUERY "anabroker-1m" ON services 
//BEGIN 
//SELECT 
...
//INTO 
//    services."1year"."anabroker-rollup"     
//FROM 
//    services."1hour".anabroker 
//GROUP BY 
...
base = from(bucket: "services/1hour") |> range(start: -10m) |> filter( fn: (r) => r._measurement == "anabroker")
toBucket = (table=<-) => table |> set(key: "_measurement", valu: "anabroke-rollup" ) |>  to(org: "0492cb87e4ea2a22", bucket: "services/1year") 
