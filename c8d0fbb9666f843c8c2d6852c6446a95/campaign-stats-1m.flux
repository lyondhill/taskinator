//CREATE CONTINUOUS
//QUERY "campaign-stats-1m" ON services 
//BEGIN 
//SELECT 
...
//INTO 
//    services."1year"."campaign-stats-rollup"     
//FROM 
//    services."1hour"."campaign-stats" 
//GROUP BY 
...
base = from(bucket: "services/1hour") |> range(start: -10m) |> filter( fn: (r) => r._measurement == "campaign-stats")
toBucket = (table=<-) => table |> set(key: "_measurement", value: "campaign-stats-rollup" ) |>  to(org: "0492cb87e4ea2a22", bucket: "services/1year") 
