...
//INTO 
//    consumers."1year"."firehydrant-1m" 
//FROM 
//    consumers."2weeks".firehydrant 
//GROUP BY 
...
base = from(bucket: "consumers/2weeks") |> range(start: -task.every) |> filter(fn: (r) => r._measurement == "firehydrant" )
toBucket = (table=<-) => table |> set(key: "_measurement", value: "firehydrant-1m" ) |>  to(org: "0492cb87e4ea2a22", bucket: "consumers/1year") 
