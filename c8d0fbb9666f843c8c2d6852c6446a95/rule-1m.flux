...
base = from(bucket: "services/1hour") |> range(start: -10m) |> filter( fn: (r) => r._measurement == "rule")
toBucket = (table=<-) => table |> set(key: "_measurement", value: "rule-rollup" ) |>  to(org: "0492cb87e4ea2a22", bucket: "services/1year") 
