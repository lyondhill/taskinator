...
//INTO 
//    services."1year"."scheduler-rollup" 
//FROM 
//    services."1hour".scheduler 
//GROUP BY 
...
base = from(bucket: "services/1hour") |> range(start: -10m) |> filter( fn: (r) => r._measurement == "scheduler")
toBucket = (table=<-) => table |> set(key: "_measurement", value: "scheduler-rollup" ) |>  to(org: "0492cb87e4ea2a22", bucket: "services/1year") 
