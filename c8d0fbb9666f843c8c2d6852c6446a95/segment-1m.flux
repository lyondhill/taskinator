...
//INTO 
//    services."1year"."segment-rollup"
//FROM 
//    services."1hour".segment 
//GROUP BY 
...
base = from(bucket: "services/1hour") |> range(start: -10m) |> filter( fn: (r) => r._measurement == "segment")
toBucket = (table=<-) => table |> set(key: "_measurement", value: "segment-rollup" ) |>  to(org: "0492cb87e4ea2a22", bucket: "services/1year") 
