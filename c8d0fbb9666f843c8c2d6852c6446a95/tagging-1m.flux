...
//INTO 
//    services."1year"."tagging-rollup" 
//FROM 
//    services."1hour".tagging 
//GROUP BY 
...
base = from(bucket: "services/1hour") |> range(start: -10m) |> filter( fn: (r) => r._measurement == "tagging")
toBucket = (table=<-) => table |> set(key: "_measurement", value: "tagging-rollup" ) |>  to(org: "0492cb87e4ea2a22", bucket: "services/1year") 
